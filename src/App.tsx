...
---
# Output Format
严格按照以下 Markdown 格式输出完整简历，禁止输出任何说明、解释或分析过程。
...
格式要求：
- 一级标题 # 用于：教育背景、工作经历、个人项目/独立项目、专业技能、语言能力等分区
- 二级标题 ## 用于：公司名称、学校名称
- 三级标题 ### 用于：项目名称（格式为"项目一：名称"、"项目二：名称"）
- 列表 - 用于：时间、职位、技能、具体工作内容等
- 禁止输出 Markdown 代码块、禁止输出任何额外说明`
};
